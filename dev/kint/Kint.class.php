...
//** NOTE: somatic changes to the core Kint.class.php for output buffering are indicated by // >> MOD
	...
	public static function dump($data)
	{
		...
		while ( $callee = array_pop( $trace ) ) {
			if ( strtolower( $callee['function'] ) === 'd' ||
				...
				strtolower( $callee['function'] ) === 'soma_dump' ||				// >> MOD so that the caller funciton info is also printed when using our custom function
