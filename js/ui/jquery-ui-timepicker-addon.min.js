...
hour:0,minute:0,second:0,millisec:0,timezone:"+0000",hourMin:0,minuteMin:0,secondMin:0,millisecMin:0,hourMax:23,minuteMax:59,secondMax:59,millisecMax:999,minDateTime:null,maxDateTime:null,onSelect:null,hourGrid:0,minuteGrid:0,secondGrid:0,millisecGrid:0,alwaysSetTime:!0,separator:" ",altFieldTimeOnly:!0,showTimepicker:!0,timezoneIso8609:!1,timezoneList:null,addSliderAccess:!1,sliderAccessArgs:null};e.extend(this._defaults,this.regional[""])}e.extend(e.ui,{timepicker:{version:"0.9.9"}});e.extend(m.prototype,
...
c=c||{};e.extend(a,c);for(var b in c)if(null===c[b]||void 0===c[b])a[b]=c[b];return this},_newInst:function(c,a){var b=new m,d={},f;for(f in this._defaults){var g=c.attr("time:"+f);if(g)try{d[f]=eval(g)}catch(k){d[f]=g}}b._defaults=e.extend({},this._defaults,d,a,{beforeShow:function(c,d){if(e.isFunction(a.beforeShow))return a.beforeShow(c,d,b)},onChangeMonthYear:function(d,f,g){b._updateDateTime(g);e.isFunction(a.onChangeMonthYear)&&a.onChangeMonthYear.call(c[0],d,f,g,b)},onClose:function(d,f){!0===
b.timeDefined&&""!=c.val()&&b._updateDateTime(f);e.isFunction(a.onClose)&&a.onClose.call(c[0],d,f,b)},timepicker:b});b.amNames=e.map(b._defaults.amNames,function(a){return a.toUpperCase()});b.pmNames=e.map(b._defaults.pmNames,function(a){return a.toUpperCase()});if(null===b._defaults.timezoneList){d=[];for(f=-11;12>=f;f++)d.push((0<=f?"+":"-")+("0"+Math.abs(f).toString()).slice(-2)+"00");b._defaults.timezoneIso8609&&(d=e.map(d,function(a){return"+0000"==a?"Z":a.substring(0,3)+":"+a.substring(3)}));
b._defaults.timezoneList=d}b.hour=b._defaults.hour;b.minute=b._defaults.minute;b.second=b._defaults.second;b.millisec=b._defaults.millisec;b.ampm="";b.$input=c;a.altField&&(b.$altInput=e(a.altField).css({cursor:"pointer"}).focus(function(){c.trigger("focus")}));if(0==b._defaults.minDate||0==b._defaults.minDateTime)b._defaults.minDate=new Date;if(0==b._defaults.maxDate||0==b._defaults.maxDateTime)b._defaults.maxDate=new Date;void 0!==b._defaults.minDate&&b._defaults.minDate instanceof Date&&(b._defaults.minDateTime=
new Date(b._defaults.minDate.getTime()));void 0!==b._defaults.minDateTime&&b._defaults.minDateTime instanceof Date&&(b._defaults.minDate=new Date(b._defaults.minDateTime.getTime()));void 0!==b._defaults.maxDate&&b._defaults.maxDate instanceof Date&&(b._defaults.maxDateTime=new Date(b._defaults.maxDate.getTime()));void 0!==b._defaults.maxDateTime&&b._defaults.maxDateTime instanceof Date&&(b._defaults.maxDate=new Date(b._defaults.maxDateTime.getTime()));return b},_addTimePicker:function(c){this.timeDefined=
...
e=a.minDate:a.minDateTime?e=a.minDateTime:a.maxDate?g=a.maxDate:a.maxDateTime&&(g=a.maxDateTime));e?(e=0==e?new Date:new Date(e),d._defaults.minDate=e,d._defaults.minDateTime=e):g?(g=0==g?new Date:new Date(g),d._defaults.maxDate=g,d._defaults.maxDateTime=g):k&&(d._defaults.onSelect=k)}return void 0===b?this._base_optionDatepicker(c,a):this._base_optionDatepicker(c,a,b)};e.timepicker=new m;e.timepicker.version="0.9.9"})(jQuery);